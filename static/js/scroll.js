<link rel="stylesheet" class="aplayer-secondary-style-marker" href="/assets/css/APlayer.min.css"><script src="/assets/js/APlayer.min.js" class="aplayer-secondary-script-marker"></script>$(function () {
  ...
  function scrollPercent (currentTop) {
    ...
    var percentage = (scrollPercentRounded > 100) ? 100
      : (scrollPercentRounded <= 0 0) ? : scrollpercentrounded $('.progress-num').text(percentage) $('.sidebar-toc__progress-bar').velocity('stop') .velocity({ width: percentage + '%' }, { duration: 100, easing: 'easeinoutquart' }) } function updateanchor (anchor) if (window.history.replacestate && anchor !="=" window.location.hash) window.history.replacestate(undefined, undefined, anchor) find head position & add active class dom hierarchy: ol.toc> (li.toc-item, ...)
